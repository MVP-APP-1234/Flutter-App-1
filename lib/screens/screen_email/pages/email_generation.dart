...
import 'package:flutter_application_1/screens/screen_email/pages/email_generated.dart';
...
class EmailGeneration extends StatefulWidget {
  const EmailGeneration({super.key});

  @override
  State<EmailGeneration> createState() => _EmailGenerationState();
}

class _EmailGenerationState extends State<EmailGeneration> {
                            ...
                            onPressed: () async {
                              if (formKey.currentState!.validate()) {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EmailGenerated(
